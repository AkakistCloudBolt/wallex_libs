...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-atomics-synchronization.tq?l=7&c=28
  void StoreJSSynchronizationPrimitiveState(TNode<JSSynchronizationPrimitive> p_o, TNode<UintPtrT> p_v);
  ...
  TNode<Uint32T> LoadJSAtomicsMutexOptionalPadding(TNode<JSAtomicsMutex> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-atomics-synchronization.tq?l=14&c=28
  void StoreJSAtomicsMutexOptionalPadding(TNode<JSAtomicsMutex> p_o, TNode<Uint32T> p_v);
  ...
  TorqueStructIteratorRecord LoadJSIteratorHelperUnderlying(TNode<JSIteratorHelper> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-iterator-helpers.tq?l=7&c=3
  void StoreJSIteratorHelperUnderlying(TNode<JSIteratorHelper> p_o, TorqueStructIteratorRecord p_v);
