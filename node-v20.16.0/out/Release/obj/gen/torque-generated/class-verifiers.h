...
class V8_EXPORT_PRIVATE TorqueGeneratedClassVerifiers{
 public:
  ...
  static void WasmNullVerify(WasmNull o, Isolate* isolate);
  ...
  static void JSDataViewOrRabGsabDataViewVerify(JSDataViewOrRabGsabDataView o, Isolate* isolate);
  static void JSDataViewVerify(JSDataView o, Isolate* isolate);
  static void JSRabGsabDataViewVerify(JSRabGsabDataView o, Isolate* isolate);
  static void JSArrayIteratorVerify(JSArrayIterator o, Isolate* isolate);
  static void JSArrayVerify(JSArray o, Isolate* isolate);
  static void TemplateLiteralObjectVerify(TemplateLiteralObject o, Isolate* isolate);
  static void AlwaysSharedSpaceJSObjectVerify(AlwaysSharedSpaceJSObject o, Isolate* isolate);
  ...
  static void JSIteratorHelperVerify(JSIteratorHelper o, Isolate* isolate);
  static void JSIteratorMapHelperVerify(JSIteratorMapHelper o, Isolate* isolate);
  static void JSIteratorFilterHelperVerify(JSIteratorFilterHelper o, Isolate* isolate);
  static void JSIteratorTakeHelperVerify(JSIteratorTakeHelper o, Isolate* isolate);
  static void JSIteratorDropHelperVerify(JSIteratorDropHelper o, Isolate* isolate);
  ...
  static void JSValidIteratorWrapperVerify(JSValidIteratorWrapper o, Isolate* isolate);
  ...
  static void TurboshaftTypeVerify(TurboshaftType o, Isolate* isolate);
  static void TurboshaftWord32TypeVerify(TurboshaftWord32Type o, Isolate* isolate);
  static void TurboshaftWord32RangeTypeVerify(TurboshaftWord32RangeType o, Isolate* isolate);
  static void TurboshaftWord32SetTypeVerify(TurboshaftWord32SetType o, Isolate* isolate);
  static void TurboshaftWord64TypeVerify(TurboshaftWord64Type o, Isolate* isolate);
  static void TurboshaftWord64RangeTypeVerify(TurboshaftWord64RangeType o, Isolate* isolate);
  static void TurboshaftWord64SetTypeVerify(TurboshaftWord64SetType o, Isolate* isolate);
  static void TurboshaftFloat64TypeVerify(TurboshaftFloat64Type o, Isolate* isolate);
  static void TurboshaftFloat64RangeTypeVerify(TurboshaftFloat64RangeType o, Isolate* isolate);
  static void TurboshaftFloat64SetTypeVerify(TurboshaftFloat64SetType o, Isolate* isolate);
