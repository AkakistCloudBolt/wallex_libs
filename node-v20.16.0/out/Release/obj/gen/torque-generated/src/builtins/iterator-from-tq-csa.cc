...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/iterator-from.tq?l=21&c=1
TorqueStructIteratorRecord GetIteratorFlattenable_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_obj) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = Is_Callable_JSAny_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp1});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp4 = UnsafeCast_Callable_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp1});
    tmp5 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<Object>{tmp4}, TNode<Object>{p_obj});
  ...
  if (block6.is_used()) {
    ...
    tmp6 = Cast_JSReceiver_1(state_, TNode<Context>{p_context}, TNode<Object>{phi_bb6_3}, &label7);
    ca_.Goto(&block9);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block10);
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp8 = Is_Callable_JSAny_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp1});
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp9 = kNextString_0(state_);
    tmp10 = CodeStubAssembler(state_).GetProperty(TNode<Context>{p_context}, TNode<Object>{tmp6}, TNode<Object>{tmp9});
    tmp11 = Is_Callable_JSAny_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp10});
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp13 = kNextString_0(state_);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, MessageTemplate::kPropertyNotFunction, TNode<Object>{tmp10}, TNode<Object>{tmp13}, TNode<Object>{p_obj});
  }
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, MessageTemplate::kSymbolIteratorInvalid);
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Bind(&block16);
  return TorqueStructIteratorRecord{TNode<JSReceiver>{tmp6}, TNode<Object>{tmp10}};
}
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/iterator-from.tq?l=143&c=13
